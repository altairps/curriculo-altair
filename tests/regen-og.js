/**
 * Regenera altair-cv/assets/og-image.png a partir do og-image.svg.
 *
...
(async () => {
  const svg = 'file://' + path.resolve(__dirname, '../altair-cv/assets/og-image.svg');
  const out = path.resolve(__dirname, '../altair-cv/assets/og-image.png');
